...
module('Integration | Component | ak-rental/detailed', function (hooks) {
  ...
  test('it renders a header with a share button', async function (assert) {
    ...
    assert.dom('.jumbo h2').containsText('BatCave');
    assert
      .dom('.jumbo p')
  ...
  test('it renders detailed information about a rental property', async function (assert) {
    ...
    assert.dom('article h3').containsText('About BatCave');
