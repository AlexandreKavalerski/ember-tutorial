...
module('Integration | Component | ak-share-button', function (hooks) {
  ...
  test('basic usage', async function (assert) {
    await render(hbs`<AkShareButton>Tweet this!</AkShareButton>`);
  ...
  test('it supports passing @text', async function (assert) {
    await render(
      hbs`<AkShareButton @text="Hello Twitter!">Tweet this!</AkShareButton>`
    );
  ...
  test('it supports passing @hashtags', async function (assert) {
    await render(
      hbs`<AkShareButton @hashtags="foo,bar,baz">Tweet this!</AkShareButton>`
    );
  ...
  test('it supports passing @via', async function (assert) {
    await render(
      hbs`<AkShareButton @via="emberjs">Tweet this!</AkShareButton>`
    );
  ...
  test('it supports adding extra classes', async function (assert) {
    await render(
      hbs`<AkShareButton class="extra things">Tweet this!</AkShareButton>`
    );
  ...
  test('the target, rel and href attributes cannot be overridden', async function (assert) {
    await render(
      hbs`<AkShareButton target="_self" rel="" href="/">Not a Tweet!</AkShareButton>`
    );
